...
class TestJS3Enc(TestCase):
    ...
    def test_ref_ls2(self):
        ...
        self.dummy_a.any_set_1 = {2, 3}
        self.dummy_a.any_set_2 = self.dummy_a.any_set_1
        JS3Enc(self.dummy_a).save(self.js, indent=2)
        d: Dummy = JS3Dec().source(self.js).decode()
        self.assertEqual(d.any_list_1, self.dummy_a.any_list_2)

    def test_ref_ls4(self):
        self.dummy_a.any_list_1 = []
        self.dummy_a.any_list_1.extend([1, self.dummy_a.any_list_1])
        JS3Enc(self.dummy_a).save(self.js, indent=2)
        d: Dummy = JS3Dec().source(self.js).decode()
        self.assertEqual(len(d.any_list_1), len(self.dummy_a.any_list_1))
